...
import com.u.ulibrary.util.UDisplayUtil;
 ...
 * 文件描述：
 */
public class UViewPrinterProvider {
    ...
    public UViewPrinterProvider(FrameLayout rootView, RecyclerView recyclerView) {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin = UDisplayUtil.dp2px(100, recyclerView.getResources());
    ...
    private void showLogView() {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, UDisplayUtil.dp2px(160, rootView.getResources()));
